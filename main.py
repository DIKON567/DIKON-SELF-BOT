...
icon = 'icon.png' #если что, вы можете поменять иконку. Тут надо указать иконку, которая будет при краше сервера, типо изменение иконки сервера, тут ее имя в файлах
